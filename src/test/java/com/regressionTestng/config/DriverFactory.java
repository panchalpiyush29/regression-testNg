...
import static com.regressionTestng.config.DriverType.FIREFOX;
import static com.regressionTestng.config.DriverType.valueOf;
...
public class DriverFactory {
    ...
    /*Specify the browser which picks capabilities defined in DriverType Enum*/
    public DriverFactory() {

        /*Default browser set to Firefox in-case of a error*/
